...
| <a name="input_stages"></a> [stages](#input\_stages) | List of Map containing information about the stages of the CodePipeline | `list(map(any))` | <pre>[<br/>  {<br/>    "category": "Test",<br/>    "input_artifacts": "SourceOutput",<br/>    "name": "ValidatePlan",<br/>    "output_artifacts": "ValidateOutput",<br/>    "owner": "AWS",<br/>    "provider": "CodeBuild"<br/>  }<br/>]</pre> | no |
